...
public class PHash implements VisualHashCalculator {
    ...
    public String getVisualHash(byte[] imageByte) throws IOException {
        return getVisualHash(ImageIO.read(new ByteArrayInputStream(imageByte)));
    }
    ...
    // on.
    @Override
    public String getVisualHash(BufferedImage img) {
